...
namespace PurchaseControlSystem.Controllers
{
    public class DivisionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DivisionId,Division_Name")] Division division)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DivisionId,Division_Name")] Division division)
        {
            if (ModelState.IsValid)
            {
