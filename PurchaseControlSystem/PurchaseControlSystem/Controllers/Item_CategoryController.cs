...
namespace PurchaseControlSystem.Controllers
{
    public class Item_CategoryController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Item_CategoryId,Description")] Item_Category item_Category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Item_CategoryId,Description")] Item_Category item_Category)
        {
            if (ModelState.IsValid)
            {
